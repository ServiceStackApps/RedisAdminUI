...
{
	public class GetCodeGeneratedJavaScriptService : RedisServiceBase
	{
		public object Any(GetCodeGeneratedJavaScript request)
		{
...
");
            ...
            var allOperationTypes = HostContext.Metadata.GetAllOperationTypes();
