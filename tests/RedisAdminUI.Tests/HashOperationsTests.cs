...
namespace RedisWebServices.Tests
{
		...
		: TestBase
	{
		...
		public void Test_GetAllEntriesFromHash()
		{
			...
			var keyValuePairs = stringMap.ToList().ConvertAll(x => new KeyValuePair(x.Key, x.Value));
		...
		public void Test_GetHashKeys()
		{
            ...
            var keys = stringMap.ToList().ConvertAll(x => x.Key);
		...
		public void Test_GetHashValues()
		{
            ...
            var values = stringMap.ToList().ConvertAll(x => x.Value);
